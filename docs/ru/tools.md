...
110 инструментов, сгруппированных по назначению. Каждый инструмент:
...
| Tool | Эффект |
|---|---|
| `batch_mutation` | Много мелких мутаций в одном вызове (быстрее, чем 110 отдельных) |
...
форка `realSeyed/figma-mcp-bridge` (MIT):
