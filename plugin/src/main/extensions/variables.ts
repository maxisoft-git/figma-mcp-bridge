...
// `cornerRadius` is bindable at runtime (Figma spreads it over the four corner
// fields) but is missing from VariableBindableNodeField in @figma/plugin-typings
// 1.123.0, so it is named here.
type BindableField =
